...
public class DiscussjiaoliuzhongxinController {
    ...
    public R security(@RequestParam String username){
        DiscussjiaoliuzhongxinEntity discussjiaoliuzhongxin = discussjiaoliuzhongxinService.selectOne(new EntityWrapper<DiscussjiaoliuzhongxinEntity>().eq("", username));
        return R.ok().put("data", discussjiaoliuzhongxin);
    }
